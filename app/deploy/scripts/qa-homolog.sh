...
curl -fsS -o /dev/null "${STAFF_URL}/" && pass "Staff SPA loads" || fail "Staff SPA"
curl -fsS -o /dev/null "${FAMILY_URL}/" && pass "Family SPA loads" || fail "Family SPA"
curl -fsS -o /dev/null "${FAMILY_URL}/convite" && pass "Invite code page" || fail "Invite page"
