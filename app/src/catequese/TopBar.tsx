...
export const TopBar = memo(function TopBar() {
  ...
  return (
    <header
      className="relative z-40 flex items-center gap-2 sm:gap-3 border-b border-brand-ink/10 bg-brand-paper/90 px-3 sm:px-4 lg:px-5 backdrop-blur supports-[backdrop-filter]:bg-brand-paper/80"
      style={{
