...
import { Sparkles, RotateCcw, ArrowLeft, Copy, Check, FileText, Smartphone } from 'lucide-react';
...
export function WhatsappResultPanel({ message, contentId, onRegenerate, onBack }: WhatsappResultPanelProps) {
    ...
    <div className="flex items-center justify-center px-3 py-6">
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button variant="default" size="sm" onClick={handleCopy} className="gap-1">
            {copied ? (
