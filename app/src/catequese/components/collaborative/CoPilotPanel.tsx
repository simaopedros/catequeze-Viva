...
import { MessageSquare, FileText, SlidersHorizontal, Circle, X } from 'lucide-react';
        ...
        <div className="mb-2 flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="truncate text-xs font-semibold text-foreground">
              {intent ? ta(`hub.${intent}` as any, t('workspace.copilot')) : t('workspace.copilot')}
            </p>
          ...
          <div className="flex items-center gap-1">
            ...
            >
              {chatOpen ? <X className="h-3.5 w-3.5" /> : <MessageSquare className="h-3.5 w-3.5" />}
            </Button>
          </div>
        </div>
