...
const BLOCKS: Array<{
...
}> = [
  {
    ...
    helper: "Clique para adicionar um título atrativo para o seu encontro...",
    icon: Type,
    type: "input",
  },
  {
  ...
  {
    field: "pastoralObjective",
    label: "Objetivo pastoral",
    helper: "Qual é o objetivo que desejamos alcançar com este encontro?",
    icon: Target,
    type: "textarea",
  ...
  },
  {
    ...
    helper: "Invoquemos a presença de Deus para este momento...",
    icon: Heart,
    type: "textarea",
    minHeight: "min-h-[110px]",
  },
  {
    ...
    helper: "Desenvolva aqui o conteúdo central do encontro...",
    icon: ScrollText,
    type: "textarea",
  ...
  },
  {
    field: "dynamic",
    label: "Dinâmica",
    helper: "Atividades para envolver e fixar o conteúdo...",
    icon: Users,
    type: "textarea",
    minHeight: "min-h-[110px]",
  },
  {
    ...
    helper: "Materiais necessários para este encontro...",
    icon: Package,
    type: "textarea",
    minHeight: "min-h-[110px]",
  },
  {
    field: "familyTask",
    label: "Compromisso para a família",
    helper: "Como a família pode viver o que foi aprendido?",
    icon: Home,
    type: "textarea",
    minHeight: "min-h-[110px]",
  },
  {
    field: "closingPrayer",
    label: "Oração final",
    helper: "Agradeçamos a Deus e confiemos nossa missão...",
    icon: Heart,
    type: "textarea",
    minHeight: "min-h-[110px]",
  },
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              {isStreaming && (
                <Badge
                  variant="secondary"
                  className="rounded-sm border border-border/70 px-2.5 py-0.5 text-xs"
                >
    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mx-auto max-w-[980px] space-y-3">
          ...
          <Button
            variant="outline"
            className="h-12 w-full rounded-sm border-dashed text-sm"
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-caption text-muted-foreground">
                  ...
                  {v.changeNotes || t("editor.no_description")}
                </div>
              </div>
              <Button
                variant="outline"
