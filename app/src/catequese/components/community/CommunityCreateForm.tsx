...
import AddressAutocomplete, {
  type AddressData,
} from "../../../client/components/AddressAutocomplete";
  ...
  return (
    <div className="space-y-4 rounded-sm border border-border/70 bg-white p-5 animate-in fade-in slide-in-from-top-2">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div>
          <label className="text-xs font-medium text-muted-foreground">
            {t("community_phone_label")}
          </label>
          <PhoneMaskInput
            value={phone}
            onChange={setPhone}
            className={inputClass}
            placeholder={t("community_phone_placeholder")}
          />
        </div>
        <div className="sm:col-span-2">
          <label className="text-xs font-medium text-muted-foreground">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div>
            <PhoneMaskInput
              ...
              onChange={setCoordinatorPhone}
              className={inputClass}
              placeholder={t("coordinator_phone_placeholder")}
            />
          </div>
        </div>
      </div>
