...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-sans text-title-xsm font-semibold leading-none tracking-tight text-brand-ink",
        className,
      )}
      {...props}
    />
