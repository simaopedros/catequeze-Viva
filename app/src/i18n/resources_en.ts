...
export const billing_en = {
    ...
    "trial_hero_subtitle_institutional_one": "Last day of this workspace trial. Subscribe to the Parish Plan to keep classes and team without interruption.",
    "trial_hero_subtitle_institutional_other": "This workspace is on trial ({{count}} days left). The Catechist Plan stays on your personal space; here, subscribe to the Parish Plan.",
