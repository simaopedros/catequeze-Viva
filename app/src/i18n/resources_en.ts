...
export const admin_en = {
    ...
    "pages": {
      ...
      "plans": {
        ...
        "editor_subtitle": "Name, limits, visibility and translations. Prices are set separately and create a new Stripe Price.",
        "col_name": "Plan",
        "col_type": "Type",
        "col_prices": "Prices",
        "col_status": "Status",
        ...
        "level_institutional": "Institutional",
        "badge_sellable": "Sellable",
        "badge_archived": "Archived",
        "badge_public": "Public",
        "badge_system": "System",
        "no_stripe_product": "No Product",
        "no_stripe_price": "No Price",
        "prices": "Prices",
        "prices_title": "Stripe prices",
        "prices_hint": "Changing the amount archives the old Price. Existing subscriptions keep charging the previous amount.",
        "no_active_price": "No active price for this interval.",
        "change_price": "Change price",
        "change_price_title": "Change list price",
        "change_price_desc": "This creates a new Stripe Price and archives the current one. Existing subscribers stay on the old amount.",
        "archived_prices": "Archived prices",
        ...
        "field_name_es": "Spanish name and features",
        "limit_classes": "Max classes",
        ...
        "social_posts": "Posts per day",
        "cancel": "Cancel",
        "save": "Save",
        "saving": "Saving…",
        "save_error": "Could not save the plan.",
        "archive": "Archive",
        "archive_title": "Archive plan",
        "archive_desc": "The plan stops being sold, but current subscribers keep access.",
        "archive_affected": "{{count}} active subscriber(s) will stay on this plan. Confirm to archive selling only.",
        "archive_error": "Could not archive the plan.",
        "limit_reduction_title": "Limit reduction",
        "limit_reduction_desc": "Some subscribers would be over the new limit. Nothing is deleted; only new items are blocked.",
      ...
      "system": {
        "title": "System",
        "subtitle": "Monitoring of maintenance tasks, editorial assistance and platform health.",
        "ai_credits_month": "Editorial credits (month)",
        "users_with_credits": "Users with credits",
        "recent_errors": "Recent errors",
        "job_errors": "Task errors ({{count}})",
        "daily_stats": "Daily stats (7d)",
        "col_date": "Date",
        "col_users": "Users",
        "col_paid": "Paid",
        "col_views": "Activity",
        ...
        "jobs": {
          ...
          "lifecycleNudge": "Activation, trial and win-back e-mails",
          "meetingReminders": "Reminders for tomorrow's meetings",
          "socialMediaReconcile": "Community media reconciliation"
        }
      },
      "parishes": {
        "title": "Parishes",
        "subtitle": "Manage every parish on the platform.",
        "empty_title": "No parishes",
        "empty_desc": "Parishes will show up here once created.",
        "col_name": "Name",
        "col_diocese": "Diocese",
        "col_city": "City",
        "col_plan": "Plan",
        ...
        "open_row": "Open parish {{name}}",
        "filtered_by": "Filtered by diocese {{name}}.",
        "clear_filter": "Clear filter"
      },
      "parish": {
        "not_found": "Parish not found.",
        "eyebrow": "Admin · Parishes",
        "open_in_app": "Open in App →",
        "kpi_classes": "Classes",
        "kpi_catechumens": "Catechumens",
        "kpi_members": "Members",
        ...
        "limits": "Limits",
        "limits_value": "{{classes}} classes / {{catechumens}} catechumens",
        "default_limit": "default",
        "no_license": "No license on record.",
        ...
        "archive": "Archive",
        "restore": "Restore",
        "archive_confirm_title": "Archive parish",
        "archive_confirm_desc": "The parish leaves the workspace switcher. Data is kept.",
        "diocese": "Diocese",
        "no_diocese": "No diocese",
        "save_diocese": "Save diocese",
        "cannot_archive_personal": "The personal workspace cannot be archived.",
        "action_error": "Could not complete the action.",
      ...
      "user": {
        ...
        "no_audit": "No actions recorded.",
        "ai_usage": "Editorial usage (30d)",
        "credits_value": "{{count}} credits",
        "suspended": "Suspended",
        ...
        "cancel_stripe": "Cancel on Stripe",
        "action_error": "Could not complete the action.",
        "suspend_title": "Suspend user",
        "suspend_desc": "Login is blocked. You can still impersonate the account for support.",
        "suspend_reason": "Reason (optional)",
        "impersonate_title": "Impersonate user",
        "impersonate_desc": "You will see the app as this user. Your admin session is stored so you can exit later.",
        "cancel_stripe_title": "Cancel Stripe subscription",
        "cancel_stripe_desc": "Immediately cancels every active subscription for this customer on Stripe. This does not issue a refund."
      },
      "dashboard": {
        "title": "Command center",
        "subtitle": "Platform overview: growth, revenue and operational alerts.",
        "users": "Users",
        "users_subtitle": "+{{count}} in the last 7 days",
        "active_parishes": "Active parishes",
        "archived_subtitle": "{{count}} archived",
        "active_classes": "Active classes",
        "catechumens_subtitle": "{{count}} catechumen(s)",
        "paying": "Paying tenants",
        "active_subs_subtitle": "{{count}} active subscription(s)",
        "mrr": "MRR",
        "trials_subtitle": "{{count}} trial(s) expiring",
        "growth_title": "Growth (30 days)",
        "alerts_title": "Alerts",
        "alert_trials_expiring": "{{count}} trial(s) expiring in 7 days",
        "alert_archived_parishes": "{{count}} archived parish(es)",
        "alert_archived_with_members": "{{count}} archived parish(es) with active members",
        "alert_no_new_users": "No new users in the last 30 days"
      },
      "analytics": {
        "title": "Analytics",
        "subtitle": "Acquisition funnel for the last {{days}} days.",
        "landing_views": "Landing views",
        "last_7d": "{{count}} in the last 7 days",
        "pricing_views": "Pricing views",
        "checkout_started": "Checkouts started",
        "purchases": "Purchases",
        "activations": "Activations",
        "funnel_title": "Funnel",
        "funnel_hint": "Cumulative conversion between each step.",
        "step_landing_viewed": "Landing viewed",
        "step_pricing_viewed": "Pricing viewed",
        "step_plan_selected": "Plan selected",
        "step_signup_started": "Signup started",
        "step_signup_completed": "Signup completed",
        "step_checkout_started": "Checkout started",
        "step_purchase_completed": "Purchase completed",
        "step_activation_completed": "Activation completed",
        "invites_title": "Invites",
        "invites_sent": "Sent",
        "invites_accepted": "Accepted",
        "invite_acceptance": "Acceptance rate",
        "share_clicked": "Shares",
        "top_plans": "Top plans",
        "no_purchases": "No purchases in this period.",
        "processors": "Processors",
        "no_processors": "No processor data.",
        "recent_purchases": "Recent purchases",
        "recent_hint": "Latest confirmed purchases.",
        "col_date": "Date",
        "col_plan": "Plan",
        "col_processor": "Processor",
        "col_user": "User",
        "no_confirmed": "No confirmed purchases."
      },
      "support": {
        "title": "Support",
        "subtitle": "Messages from the public contact form.",
        "subtitle_unread": "{{count}} unread message(s)",
        "empty_title": "Inbox empty",
        "empty_desc": "Public contact messages show up here.",
        "new": "New",
        "replied": "Replied",
        "reply": "Reply",
      ...
      "audit": {
        ...
        "entity_placeholder": "Entity type",
        "user_placeholder": "User ID",
        "parish_placeholder": "Parish ID",
        "count": "{{count}} record(s)",
        "empty_title": "No events",
        "empty_desc": "Audit events show up here.",
        "col_date": "Date",
        "col_action": "Action",
        "col_entity": "Entity",
      ...
      "licenses": {
        "title": "Licenses",
        "subtitle": "Trials, complimentary plans and immediate Stripe cancellation. A later webhook from a real subscription may overwrite a complimentary plan.",
        "col_entity": "Entity",
        "col_owner": "Owner",
        "col_type": "Type",
        "col_plan": "Plan",
        ...
        "no_owner": "No owner",
        "search_placeholder": "Search by entity, email or plan",
        ...
        "extend_desc": "Adds days to the local trial. Creates a TRIAL license if none exists.",
        "complimentary_title": "Grant complimentary plan",
        "complimentary_desc": "Applies the plan locally, without Stripe. A webhook from a real subscription may overwrite this.",
        "cancel_license_title": "Cancel local license",
        "cancel_license_desc": "Marks the license as canceled and returns to the free plan. Does not cancel Stripe.",
        "cancel_stripe_title": "Cancel immediately on Stripe",
        "cancel_stripe_desc": "Cancels the subscription on Stripe now. Confirm only if that is what you intend.",
      ...
      "deals": {
        "title": "Diocese deals",
        "subtitle": "Negotiated Cúria subscriptions: parish seats, dates and status. Payment is offline (PIX, invoice or bank transfer) — no Stripe Checkout.",
        "new": "New deal",
        "new_title": "New pastoral deal",
        "edit_title": "Edit pastoral deal",
        "form_desc": "Set how many parishes are covered and the internal commercial terms. The diocese office only sees a summary, not the agreed price.",
        "search_placeholder": "Search diocese or reference",
        "filter_status": "Filter by status",
        "filter_all": "All statuses",
        "empty": "No diocese deals yet",
        "empty_desc": "When a diocese agrees terms, record here how many parishes they may use.",
        "col_diocese": "Diocese",
        "col_status": "Status",
        "col_parishes": "Parishes",
        "col_actions": "Actions",
        "edit": "Edit",
        "activate": "Activate",
        "suspend": "Suspend",
        ...
        "status_NONE": "No deal",
        "unlimited": "Unlimited",
        "existing_diocese": "Existing diocese",
        "choose_diocese": "Choose a diocese…",
        "new_diocese": "Or register a new diocese",
        "new_diocese_placeholder": "Diocese name",
        "max_parishes": "Max parishes",
        "max_parishes_required": "Enter how many parishes the deal covers.",
        "max_classes": "Max classes (optional)",
        "max_catechists": "Max catechists (optional)",
        "max_catechumens": "Max catechumens (optional)",
        "status": "Status",
        "starts": "Starts",
        "ends": "Ends",
        "contract_ref": "Contract reference",
        "agreed_price": "Agreed amount (internal)",
        "notes": "Internal notes",
        "notes_placeholder": "Agreed price, PIX, contract number, Cúria contact…",
        "cancel": "Cancel",
        "save": "Save deal",
        "saving": "Saving…",
        "action_error": "Could not save the deal.",
        "confirm_status_title": "Change deal status",
        "confirm_status_desc": "The deal for {{name}} will become {{status}}. Parish data stays in place.",
        "confirm": "Confirm"
      }
    },
    "loading": "Loading…",
...
export const attendance_en = {
    ...
    "sheet": {
      ...
      "empty_desc": "Create today's meeting to start roll call.",
      "create_today_meeting": "Create today's meeting",
      "create_meeting_ok": "Meeting created. Mark attendance below.",
      "create_meeting_error": "Could not create meeting",
      "default_meeting_title": "Today's meeting",
...
export const auth_en = {
    ...
    "login_error_generic": "We couldn't sign you in right now. Check your connection and try again.",
    ...
    "email_verification_subject": "Confirm your catechesis team email — Catequese Viva",
    "email_verification_body": "You created an account on the pastoral dashboard (catechists and coordinators). Click the link to confirm your email:",
    "email_verification_button": "Confirm team email",
    ...
    "password_reset_subject": "Reset catechesis team password — Catequese Viva",
    "password_reset_body": "Use this link to reset the password for your pastoral dashboard account:",
    "password_reset_button": "Reset team password",
    ...
    "email_verification_subject_staff": "Confirm your catechesis team email — Catequese Viva",
    "email_verification_body_staff": "You created an account on the pastoral dashboard (catechists and coordinators). Click the link to confirm your email:",
    "email_verification_button_staff": "Confirm team email",
    "email_verification_subject_family": "Confirm your Family Portal email — Catequese Viva",
    "email_verification_body_family": "You created an account on the Family Portal. Click the link to confirm your email:",
    "email_verification_button_family": "Confirm Family Portal email",
    "password_reset_subject_staff": "Reset catechesis team password — Catequese Viva",
    "password_reset_body_staff": "Use this link to reset the password for your pastoral dashboard account:",
    "password_reset_button_staff": "Reset team password",
    "password_reset_subject_family": "Reset Family Portal password — Catequese Viva",
    "password_reset_body_family": "Use this link to reset the password for your Family Portal account:",
    "password_reset_button_family": "Reset Family Portal password"
  } as const;
...
export const billing_en = {
    ...
    "plan_mismatch_personal": "The Catechist Plan is billed on your personal space. In this pastoral workspace, subscribe to the Parish Plan.",
    "plan_mismatch_personal_cta": "Open personal space",
    ...
    "trial_status_desc_other": "{{count}} days left on your free trial. You already use Catechist Plan limits.",
    "trial_status_desc_institutional_one": "1 day left on this workspace trial. Subscribe to the Parish Plan for unlimited classes and catechumens.",
    "trial_status_desc_institutional_other": "{{count}} days left on this workspace trial. Subscribe to the Parish Plan for unlimited classes and catechumens.",
    ...
    "trial_hero_subtitle_institutional_one": "Last day of this workspace trial. Subscribe to the Parish Plan for unlimited classes and catechumens.",
    "trial_hero_subtitle_institutional_other": "This workspace is on trial ({{count}} days left). Subscribe to the Parish Plan for unlimited classes and catechumens.",
    "institutional_trial_plan_label": "Parish trial",
    "trial_usage_caption": "These are trial limits. The Parish Plan unlocks unlimited classes and catechumens.",
    ...
    "pricing_section_subtitle_personal": "In this personal space, subscribe to the Catechist Plan.",
    "pricing_section_subtitle_institutional": "In this pastoral workspace, subscribe to the Parish Plan.",
    "unlimited": "unlimited",
    ...
    "parish_offer": {
      ...
      "headline_no_trial": "Take your parish catechesis to the next level",
      "result_trial": "Keep using Catequese Viva with no limits.",
      "result_no_trial": "Keep your whole team, classes, and catechumens in one place.",
      ...
      "most_popular": "Most popular",
      "plan_result": "The whole parish catechesis in one place",
      "plan_audience": "For your parish team",
      "per_month": "/month",
      "billed_annually": "billed annually: {{price}}",
      "save_year": "save {{price}}",
      "cta": "Subscribe to the Parish Plan",
      "secure_payment": "Secure payment via Stripe",
      "diocese_title": "Your parish may be covered by the Diocese",
      "diocese_desc": "If your diocese has an active license, your parish can be linked to the Diocese Plan.",
      "diocese_cta": "Talk to sales about diocesan coverage",
      "diocese_question": "Need coverage for several parishes?",
    ...
    "personal_active": {
      ...
      "usage_title": "Your usage",
      "usage_classes": "{{used}} of {{limit}} classes",
      "usage_catechumens": "{{used}} of {{limit}} catechumens",
      "usage_bridge": "Need more room?",
      "usage_bridge_desc": "Organize your parish with unlimited classes and catechumens.",
      "next_step": "Next step",
      "parish_title": "Take your catechesis to the whole parish",
      "parish_desc": "Invite your team, create unlimited classes, and follow every catechumen in one workspace.",
      "parish_cta": "Organize as a parish",
      "parish_feature_classes": "Unlimited classes and team",
      "parish_feature_catechumens": "Unlimited catechumens",
      "parish_feature_team": "Institutional parish workspace",
      "parish_feature_comms": "Communication with families",
    ...
    "managed_notice": {
      ...
      "paused_headline": "This diocese's pastoral deal is not active",
      "paused_headline_named": "The pastoral deal for diocese {{name}} is not active",
      "paused_result": "Parish data stays in place. There is no checkout here — the Cúria settles the deal with Catequese Viva."
    },
    "deal": {
      "eyebrow": "Pastoral deal",
      "covering_desc": "Parishes in this diocese use the coverage agreed with Catequese Viva.",
      "paused_desc": "While the deal is not active, new parishes cannot join this diocese. Existing data stays.",
      "parishes": "Parishes in the deal",
      "parishes_used": "{{used}} of {{max}}",
      "parishes_unlimited": "unlimited",
      "classes": "Classes (cap)",
      "catechists": "Catechists (cap)",
      "catechumens": "Catechumens (cap)",
      "starts": "Starts: {{date}}",
      "ends": "Ends: {{date}}",
      "status_ACTIVE": "Active",
      "status_SUSPENDED": "Suspended",
...
export const classes_en = {
    ...
    "community": "Community",
    "parish": "Parish",
    "community_placeholder": "Parish (no specific community)",
    "community_optional": "Optional — link to a community or chapel.",
    "create_parish_first": "Create a parish before adding institutional classes.",
    "create_parish_cta": "Create parish",
    "days": {
      "0": "Sunday",
      "1": "Monday",
      "2": "Tuesday",
    ...
    "detail": {
      ...
      "empty_cta_attendance": "Take roll call",
      ...
      "role_class_coordinator": "Coordinator",
    ...
    "limit_used_of_plan": "You used {{currentCount}} of {{maxAllowed}} classes on the Catechist Plan"
  } as const;
...
export const common_en = {
    ...
    "team": {
      "scope": {
        ...
        "description": "Choose which classes {{name}} oversees. Without a community or classes, they see the whole parish.",
        "community_label": "Community",
        "no_community": "No community (selected classes only)",
        "classes_label": "Classes under responsibility",
        "no_classes": "No classes yet.",
        "full_parish_hint": "No scope set: whole-parish view (as today).",
        "scoped_hint": "They will only see the classes, catechists and catechumens in this scope.",
        "saved": "Scope updated.",
        "edit": "Set scope",
        "classes_count_one": "{{count}} class",
        "classes_count_other": "{{count}} classes",
        "full_parish": "Whole parish",
      ...
      "family_invites_hint": "To invite guardians or catechumens, use Family Invites — this page is only for the pastoral team.",
      "open_family_invites": "Open family invites"
    },
    "pending_invite": {
      "banner_one": "You have a pending invite to {{name}}",
      "banner_many": "You have {{count}} pending invites",
      "banner_hint": "Accept to join the workspace.",
...
export const content_en = {
    ...
    "library": {
      ...
      "import": "Import file",
      "import_title": "Import document",
      "import_hint": "Drop a PDF, Word (.docx), or text file, or click to choose one.",
      "import_formats": "Formats: PDF, DOCX, TXT, and Markdown. Maximum 10 MB.",
      "import_drag_over": "Drop the file here",
      "import_selected": "{{name}} ({{size}})",
      "import_submit": "Import and edit",
      "import_importing": "Importing…",
      "import_cancel": "Cancel",
      "import_success": "Document imported. Review the text in the editor.",
      "download_original": "Download original",
      "error_import": "Could not import the file.",
      "error_import_invalid_type": "Use PDF, Word (.docx), TXT, or Markdown.",
      "error_import_empty_text": "Could not extract text. If this is a scanned PDF, export it with selectable text.",
      "error_import_too_large": "File is too large. Maximum: 10 MB.",
    ...
    "print_page": {
      ...
      "preview_badge": "A4 pre-print",
      "preview_hint": "A4 print preview. Check that text is not cut off before printing.",
    ...
    "workspace": {
      ...
      "save_draft_first": "Save the draft first",
      "save_draft_before_refs": "Edit the title or the script before attaching references.",
      "save_draft_before_links": "Edit the meeting before linking references.",
      "save_draft_before_images": "Edit the meeting before uploading images.",
      "error": "Error",
      "editor_open_error": "Could not open the editor.",
      "save_error": "Error while saving",
      "try_again": "Please try again.",
      "nothing_to_save": "Nothing to save",
      "nothing_to_save_desc": "Edit the meeting title or script.",
      "download_error": "Download error",
      "download_error_desc": "Could not download the original file.",
      "deleted_title": "Meeting deleted",
      "deleted_desc": "The draft was removed.",
      "delete_error": "Error while deleting",
      "delete_error_desc": "Could not delete.",
      "link_bible_error": "Could not link the Bible reference.",
      "link_catechism_error": "Could not link the Catechism reference.",
      "link_directory_error": "Could not link the Directory reference.",
      "status_saving": "Saving…",
      "status_save_failed": "Save failed",
      "status_saved_at": "Saved at {{time}}",
      "status_saved": "Saved",
      "status_unsaved": "Not saved",
      "status_local_draft": "Local draft",
      "back_to_library": "Back to library",
      "title_placeholder": "Meeting title",
      "theme_placeholder": "Theme",
      "duration_minutes": "Duration in minutes",
      "tags_placeholder": "Tags",
      "script_placeholder": "Write the meeting script in this section…",
      "retry": "Try again",
      "save": "Save",
      "delete_confirm_title": "Delete this draft?",
      "delete_confirm_desc": "This action cannot be undone. The meeting will be removed from the library.",
      "delete_confirm_label": "Delete"
    },
    "editor": {
      "bible": "Bible",
      "close_bubble": "Close popover",
      "close": "Close",
      "search_passage": "Search passage",
      "search_catechism": "Search the Catechism",
      "search_directory": "Search the Directory",
      "placeholder": "Write the meeting here...",
      "save": "Save",
      "paragraph": "Paragraph",
      "heading1": "Heading 1",
      "heading2": "Heading 2",
...
export const dashboard_en = {
    ...
    "greeting_morning_anonymous": "Good morning!",
    ...
    "action": {
      "prepare_meeting": {
        "title": "Prepare encounter",
        "subtitle": "{{meetingTitle}} · {{className}}",
        "context": "You have not added content to this encounter yet.",
        "cta": "Prepare encounter"
      },
      "start_meeting": {
        "title": "Start encounter",
        "subtitle": "{{meetingTitle}} · {{className}}",
        "context": "The plan is ready. When the class arrives, start the encounter and take attendance.",
        "cta": "Start encounter"
      },
      "continue_attendance": {
        "title": "Continue roll call",
        "subtitle": "{{className}} · {{registered}} of {{total}} recorded",
        "context": "The encounter is in progress and some attendance records are still missing.",
        "cta": "Continue roll call"
      },
      "complete_meeting": {
        "title": "Finish encounter",
        "subtitle": "{{meetingTitle}} · {{className}}",
        "context": "All attendance has been recorded. Finish the encounter to close the record.",
        "cta": "Finish encounter"
      },
      "register_attendance": {
        "title": "Record attendance",
        "subtitle": "{{className}} · {{count}} catechumens",
        "context": "Attendance for the last encounter has not been recorded yet.",
        "cta": "Record attendance"
      },
      "low_frequency": {
        "title": "Low attendance",
        "subtitle": "{{count}} catechumens",
        "context": "Below {{threshold}}% attendance. Follow up and talk to the families to encourage them.",
        "cta": "See details"
      },
      "birthday": {
        "title": "Upcoming birthday",
        "subtitle": "{{name}}",
        "context": "How about preparing a special treat for the class to celebrate?",
        "cta": "See catechumen"
      },
      "pending_sacraments": {
        "title": "Sacramental pending items",
        "subtitle": "{{count}} pending",
        "context": "There are sacramental milestones waiting for follow-up.",
        "cta": "See pending items"
      }
    },
    "status": {
      "ok": "Your catechesis is up to date",
      "ok_desc": "No urgent action right now. Keep following up with the class.",
    ...
    "my_catechesis": "My catechesis",
    "see_full_report": "See full report",
    "see_classes": "See classes",
    "see_report": "See report",
    "see_pending": "See pending items",
    "active_class_one": "Active class",
    "trend_down": "{{pct}}% in the last month",
    "trend_up": "{{pct}}% in the last month",
    "my_class": "My class",
    "catechumens_count_one": "{{count}} catechumen",
    "catechumens_count_other": "{{count}} catechumens",
    "attendance_avg_label": "Average attendance",
    "last_meeting": "Last encounter",
    "present_count_one": "{{count}} present",
    "present_count_other": "{{count}} present",
    "of_registered": "of {{total}} recorded",
    "no_meetings_yet": "No encounter held yet.",
    "low_frequency_count_one": "{{count}} catechumen with low attendance",
    "low_frequency_count_other": "{{count}} catechumens with low attendance",
    "open_class": "Open class",
    "class_all_clear": "No catechumen with low attendance.",
    "upcoming_birthdays": "Upcoming birthdays",
    "no_upcoming_birthdays": "No birthdays in the next 30 days.",
    "birthday_hint": "How about preparing a special treat?",
    "see_birthdays": "See birthdays",
    "quick_new_catechumen_desc": "Add a new catechumen",
    "quick_import_list": "Import list",
    "quick_import_list_desc": "Import several catechumens",
    "recent_meetings": "Recent encounters",
    "attendance_not_registered": "Attendance not recorded",
    "activation": {
      ...
      "step_attendance_title": "Take your first roll call",
      "step_attendance_desc": "Mark who came — it takes less than a minute.",
...
export const emails_en = {
    "fallback_name": "catechist",
    "fallback_class": "your class",
    "footer_reason": "You received this email because you created a Catequese Viva account.",
    "unsubscribe": "I don't want these emails anymore",
    ...
    "campaigns": {
      "activate_create_class": {
        ...
        "heading": "Your catechesis is still on paper",
        "body": "Hi, {{name}}. Create the class in about 2 minutes to start attendance and meetings in one place.",
        "cta": "Create my class"
      },
      "activate_add_people": {
        "subject": "Add catechumens to {{className}}",
        "heading": "{{className}} is empty",
        "body": "Hi, {{name}}. Without names, you can't take attendance or message families.",
        "cta": "Add catechumens"
      },
      "activate_first_action": {
        "subject": "Sunday comes fast — record attendance",
        "heading": "The first meeting or roll call is still missing",
        "body": "Hi, {{name}}. Record attendance or prepare the first meeting for {{className}}.",
        "cta": "Record attendance"
      },
      "convert_after_value": {
        "subject": "Your class is live — keep access",
        "heading": "Attendance and meetings are already on Catequese Viva",
        "body": "Hi, {{name}}. Subscribe to the Catechist Plan ({{price}}/month) so you don't lose access on {{trialEndsAt}}.",
        "cta": "Subscribe now"
      },
      "trial_d3": {
        "subject": "3 days left on your trial",
        "heading": "You have 3 days left",
        "body_no_class": "Hi, {{name}}. There is still time to create the class before the trial ends. It takes about 2 minutes.",
        "body_no_people": "Hi, {{name}}. {{className}} still has no catechumens. Add the list so you can take attendance.",
        "body_no_action": "Hi, {{name}}. Record the first attendance or create the first meeting for {{className}}.",
        "body_value": "Hi, {{name}}. Your class is already live. Subscribe to the Catechist Plan ({{price}}/month) so you don't lose access on {{trialEndsAt}}.",
        "cta_next_step": "Continue now",
        "cta_billing": "View subscription"
      },
      "trial_d1": {
        "subject": "Your trial ends tomorrow",
        "heading": "The trial period ends tomorrow",
        "body_no_class": "Hi, {{name}}. There is still time to create the class today and see Catequese Viva in action.",
        "body_no_people": "Hi, {{name}}. Add the catechumens for {{className}} today — the trial ends tomorrow.",
        "body_no_action": "Hi, {{name}}. Record attendance or prepare the meeting for {{className}} before the trial ends tomorrow.",
        "body_value": "Hi, {{name}}. The trial ends tomorrow. Subscribe to the Catechist Plan ({{price}}/month) to keep class, attendance, and meetings.",
        "cta_next_step": "Continue now",
        "cta_billing": "Subscribe now"
      },
      "winback_d1": {
        "subject": "Your class is still saved",
        "heading": "The trial ended, but your data did not",
        "body": "Hi, {{name}}. Reactivate the Catechist Plan ({{price}}/month) to take attendance and prepare meetings again.",
        "cta": "Reactivate access"
      },
      "winback_d3": {
        "subject": "Your catechesis is still here",
        "heading": "Three days without access to the class",
        "body": "Hi, {{name}}. {{className}} is still saved. Reactivate the Catechist Plan ({{price}}/month) whenever you want to resume attendance.",
        "cta": "Reactivate access"
      },
      "winback_d7": {
        "subject": "An invitation to resume catechesis",
        "heading": "Your class is waiting",
        "body": "Hi, {{name}}. It's been a week since the trial ended. The Catechist Plan is {{price}}/month — reactivate to pick up where you left off.",
        "cta": "Return to Catequese Viva"
      }
    }
  } as const;
...
export const family_en = {
    ...
    "staff_portal_badge": "Pastoral Team",
    "app_name": "Catequese Viva",
    "landing": {
    ...
    "invite": {
      ...
      "title_staff": "Invitation to the catechesis team",
      "as_role": "as {{role}}",
      ...
      "login_to_accept_staff": "To accept the pastoral team invitation, sign in or create an account.",
      "accepted_title": "Invitation Accepted!",
      "accepted_desc": "You are now part of {{parish}} as {{role}}.",
      "redirecting": "Redirecting to your dashboard...",
      "redirecting_staff": "Redirecting to the pastoral dashboard...",
    ...
    "portal_invites": {
      "title": "Family Portal Invites",
      "subtitle": "Invite guardians and catechumens to follow meetings, attendance and documents in the family portal — without pastoral admin access.",
      "how_title": "How it works",
      "how_1": "You send an invite with email and role (guardian or catechumen).",
      "how_2": "They open the link (email or WhatsApp) on the family portal.",
      "how_3": "They sign up or log in with the same email and accept the invite.",
      "how_4": "They only see their own family / their own profile.",
      "how_note": "WhatsApp is only for sharing the link. Login is always by email. Family users never see roll call, class admin or billing.",
      "create_title": "New invite",
      "email_label": "Email",
      "email_placeholder": "email@example.com",
      "role_label": "Portal role",
      "role_guardian": "Guardian (family)",
      "role_catechumen": "Catechumen (own account)",
      "family_label": "Family (recommended)",
      "family_optional": "Select family…",
      "send": "Send invite",
      "link_ready": "Link ready to copy or share on WhatsApp",
      "copy_link": "Copy link",
      "copied": "Link copied!",
      "whatsapp_text": "Hi! Here is your invite to the catechesis Family Portal: {{url}}",
      "pending_title": "Pending invites",
      "pending_count": "{{count}} pending",
      "empty_title": "No pending invites",
      "empty_desc": "When you invite a guardian or catechumen, status appears here to resend or copy the link.",
      "col_person": "Person",
      "col_role": "Role",
      "col_status": "Status",
      "col_expires": "Expires",
      ...
      "tip_context": "Tip: you can also invite from the family or catechumen page. This hub lists all portal invites.",
      "open_portal": "Open family portal",
      "need_parish": "Select a parish",
      "need_parish_desc": "Choose the parish workspace to manage family portal invites.",
      "banner_title": "Family Portal invites in one place",
      "banner_desc": "Invite guardians and catechumens, track pending invites, copy the link or share on WhatsApp.",
      "banner_cta": "Open invites",
      "context_guardian": "Invite this guardian to the portal",
      "context_catechumen": "Invite to the family portal",
      "context_family": "Invite family to the portal"
    }
  } as const;
...
export const hierarchy_en = {
    ...
    "library": {
      ...
      "update_error": "Could not save the resource.",
      "deleted": "Resource deleted.",
      "delete_error": "Could not delete the resource.",
      "delete_title": "Delete draft",
      "delete_confirm": "This draft will be permanently deleted.",
      "archive": "Archive",
      "archived": "Resource archived.",
      "archive_title": "Archive resource",
      "archive_confirm": "Parishes will no longer see this published resource, but the history remains.",
      ...
      "download_error": "Could not download the attachment.",
    ...
    "itinerary": {
      ...
      "update_error": "Could not save the itinerary.",
      "deleted": "Itinerary deleted.",
      "delete_error": "Could not delete the itinerary.",
      "delete_title": "Delete itinerary",
      "delete_confirm": "This draft will be permanently deleted.",
      "archive": "Archive",
      "archived": "Itinerary archived.",
      "archive_confirm": "Instantiated years remain; the itinerary is no longer offered to parishes.",
      "policy": "Inheritance policy",
      "status": "Status",
      "stages": "Stages",
      "add_stage": "Add stage",
      ...
      "empty_desc": "The diocese publishes official itineraries; the parish instantiates the catechetical year from them.",
      "publish": "Publish",
    ...
    "formation": {
      ...
      "subtitle": "Build formation courses with modules and lessons. The diocese publishes the program; the parish enrolls the team and tracks progress.",
      "new": "New formation",
      "name": "Name",
      "name_placeholder": "Initial catechist formation",
      "hours": "Hours",
      "hours_placeholder": "Total hours (optional)",
      "desc_placeholder": "Goal, audience and what the team will learn…",
      "saving": "Saving…",
      "created": "Formation created. Now build the program.",
      "create_error": "Could not create the formation.",
      "enroll": "Enroll",
      "unenroll": "Unenroll",
      "open": "Open formation",
      "policy": "Inheritance policy",
      "updated": "Formation updated.",
      "update_error": "Could not save the formation.",
      "deleted": "Formation deleted.",
      "delete_error": "Could not delete.",
      "delete_title": "Delete formation",
      "delete_confirm": "Formations with enrollments or content are archived; empty drafts are deleted.",
      "archived": "Formation archived.",
      "not_found": "Formation not found",
      "detail_subtitle": "{{modules}} modules · {{lessons}} lessons · {{sessions}} live sessions · {{enrolled}} enrolled",
      "inherited_readonly": "Official program: the parish enrolls the team and tracks progress, but only the curia edits modules and lessons.",
      "tab_program": "Program",
      "tab_sessions": "Live sessions",
      "tab_roster": "Enrolled",
      "curriculum_title": "Course program",
      "curriculum_hint": "Organize the formation into modules. Each module holds the lessons with content, duration and materials.",
      "add_module": "Add module",
      "module_title": "Module title",
      "module_title_placeholder": "Module 1 — Identity of the catechist",
      "module_desc_placeholder": "What this module covers…",
      "save_module": "Save module",
      "module_created": "Module created.",
      "module_updated": "Module updated.",
      "module_error": "Could not save the module.",
      "module_deleted": "Module deleted.",
      "delete_module_title": "Delete module",
      "delete_module_confirm": "Lessons in this module will also be deleted.",
      "empty_curriculum": "No modules yet. Create the first one to start adding lessons.",
      "empty_curriculum_readonly": "This formation does not have a published program yet.",
      "lessons_count": "{{count}} lessons",
      "add_lesson": "Add lesson",
      "lesson_title": "Lesson title",
      "lesson_title_placeholder": "Lesson 1 — Call and vocation",
      "lesson_body": "Content",
      "lesson_body_placeholder": "Lesson text, outline, scripture, discussion questions…",
      "lesson_duration": "Duration (minutes)",
      "lesson_video": "Video (URL)",
      "lesson_resource": "Support material (URL)",
      "save_lesson": "Save lesson",
      "lesson_created": "Lesson created.",
      "lesson_updated": "Lesson updated.",
      "lesson_error": "Could not save the lesson.",
      "lesson_deleted": "Lesson deleted.",
      "delete_lesson_title": "Delete lesson",
      "delete_lesson_confirm": "Learner progress on this lesson will also be deleted.",
      "empty_lessons": "No lessons in this module.",
      "open_lesson": "Open lesson",
      "close_lesson": "Close lesson",
      "mark_complete": "Mark as complete",
      "completed": "Completed",
      "reopen_lesson": "Reopen lesson",
      "progress": "{{done}} of {{total}} lessons completed",
      "enroll_to_progress": "Enroll to track lesson progress.",
      "sessions_title": "Live sessions",
      "sessions_hint": "Schedule in-person or live sessions. The course program (modules and lessons) lives above.",
      "add_session": "Session",
      "session_title": "Session title",
      "session_starts": "Starts",
      "session_ends": "Ends",
      "session_location": "Location",
      "session_hours": "Hours for this session",
      "location_placeholder": "Parish hall, seminary…",
      "notes_placeholder": "Agenda, materials, notes…",
      ...
      "delete_session_confirm": "Attendance for this session will also be deleted.",
      "empty_sessions": "No live sessions scheduled. The course program can exist without a calendar date.",
      "mark_present": "Mark present",
      "present": "Present",
      "absent": "Absent",
      "attendance": "Attendance",
      "enrollments_title": "Enrolled",
      "empty_title": "No formations",
      "empty_desc": "Create the first formation with modules and lessons, or wait for the diocese to publish the catechist school.",
      "meta": "{{modules}} modules · {{lessons}} lessons · {{enrolled}} enrolled · {{hours}}h",
      "kinds": {
        "INITIAL": "Initial",
        "PERMANENT": "Ongoing",
...
export const landing_en = {
    "hero": {
      ...
      "subheadline": "Catequese Viva keeps meetings, classes, and catechumens organized so you have more time to be with them.",
    ...
    "pains": [
      {
        "text": "Preparing every weekly meeting takes time, references, and creativity"
      },
      {
    ...
    "mission_text": "Catequese Viva exists to serve your mission — not the other way around. Less improvisation and paperwork, more real presence with each catechumen God entrusted to you.",
    "personas_title": "Built for the catechist — and ready for the families in your class",
    "personas_subtitle": "In this phase, the journey is yours: you care for the class and families follow along in the portal.",
    "personas": [
      {
        "title": "Catechist",
    ...
    "plans": {
      ...
      "diocese": {
        ...
        "desc": "To coordinate and follow several parishes.",
        "price": "Talk to sales",
        "features": [
          "Coverage for parishes",
          "Team license",
    ...
    "faq_subtitle": "Clear answers so you can start with peace of mind.",
    "faqs": [
      {
      ...
      {
        "q": "Do I have to register everything at once?",
        "a": "No. You can start with a few catechumens and add the rest later."
      },
      {
        "q": "Can I start on my own and later move to a parish?",
        "a": "Yes. Start on the Catechist Plan and, as your catechesis grows, move the organization to the Parish Plan."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes. No lock-in and no penalty."
      },
      {
        "q": "Does it work on mobile?",
        "a": "Yes. You can organize the class and take attendance in the browser, with no app to install."
      }
    ],
    "cta_eyebrow": "Back to what matters",
    "cta_title": "Get back the time for what called you to catechesis.",
    "cta_subtitle": "Leave the organization to Catequese Viva and live the meeting with more presence, calm, and purpose.",
    "cta_lines": [],
    ...
    "mock": {
      ...
      "credits": "A draft for you to review",
    ...
    "proof": {
      ...
      "title": "Built for those who truly live catechesis",
      "subtitle": "You prepare the meeting, walk with each catechumen, and journey together with the families — all at the service of your mission, from the first meeting to the last.",
      "stats": [
        {
          "title": "For your mission",
          "desc": "Your class, mobile attendance, and meeting prep in one place — so there is time left for people."
        },
        {
          "title": "For the families in your class",
          "desc": "Notices, attendance, and absence justifications in the portal — families walk with you."
        },
        {
          "title": "On mobile",
    ...
    "comparison": {
      ...
      "subtitle": "Compare your current workflow with Catequese Viva on what matters in your week with the class.",
    ...
    "demo": {
      "badge": "Intelligence that helps",
      "title": "You don't need to start with a blank page.",
      "subtitle": "Share the theme and your class profile. Catequese Viva helps turn the idea into a meeting ready for you to review.",
      "helper": "",
    ...
    "outcomes": {
      "title": "What changes in your week",
      "subtitle": "",
      "items": [
        {
          "title": "Organized class",
          "desc": "Single registry for catechumens. Import from a spreadsheet if you already have a list."
        },
        {
          "title": "Mobile attendance",
          "desc": "Present, absent, late, and justified during the meeting. History is saved."
        },
        {
          "title": "Prepared meeting",
          "desc": "Outline with Bible and Catechism in one place. You review before using."
        }
      ],
      "eyebrow": "In practice"
    },
    "steps_eyebrow": "",
    "faq_eyebrow": "Before you begin",
    "problem": {
      "eyebrow": "In practice",
      "title": "More heart in the meeting.",
      "title_line2": "Less weight in the week.",
      "subtitle": "You already know how to catechize. What you need is less to organize.",
      "items": [
        {
          "title": "Everything scattered",
          "desc": "WhatsApp, notebooks, spreadsheets, and separate files for the same class."
        },
        {
        ...
        },
        {
          ...
          "desc": "Arriving at the meeting already tired from organizing everything first."
        }
      ]
    },
    "how": {
      "eyebrow": "A simpler way",
      "title": "From preparation to follow-up, all in one place.",
      "subtitle": "A lighter routine.",
      "rows": [
        {
          "step": "01 · Prepare",
          "title": "Arrive knowing what to do.",
          "desc": "Organize the next meeting without starting from scratch.",
          "bullets": [
            "Meeting outline",
            "Calendar",
        ...
        {
          "step": "02 · Organize",
          "title": "Classes, catechumens, and attendance without a spreadsheet.",
          "desc": "Have the view you need to follow your class without hunting information in several places.",
          "bullets": [
            "Organized classes",
            "Catechumen registry",
            "Attendance records"
          ...
          "visual": [
            "Confirmation class · 22 catechumens",
            "✓ 19 present",
            "○ 3 absent",
            "Attendance history →"
          ]
        },
        {
          ...
          "desc": "The journey history stays organized for you and your team.",
          "bullets": [
            "Meeting history",
            "Class calendar",
            "Ongoing follow-up"
...
export const onboarding_en = {
    ...
    "personal_setup": {
      ...
      "ai_generator": "Meeting preparation",
    ...
    "diocese": {
      ...
      "not_found_link": "+ Not found? Ask about the Diocese plan",
      "not_found_title": "Creating a diocese is an institutional plan",
      "not_found_body": "Only the platform team can register new dioceses. You can continue without a diocese and set up the parish as usual — or talk to sales about the Diocese plan.",
      "continue_without": "Continue without a diocese",
      "whatsapp_question": "Want the Diocese plan for your region?",
      "whatsapp_helper": "Sales can explain coverage, pricing, and how to activate the Diocese plan.",
      "whatsapp_cta": "Ask about the Diocese plan on WhatsApp",
      "whatsapp_prefill": "Hi! I'm signing up for Catequese Viva and want to learn more about the Diocese plan.",
      "skip": "Skip this step →",
    ...
    "shell": {
      ...
      "personal_people_subtitle": "Add names now or skip — roll call is already set up.",
    ...
    "catechumens_setup": {
      ...
      "continue_attendance": "Take roll call with {{count}} enrolled",
      "continue_attendance_empty": "Go to roll call",
      "skip": "Finish without adding now",
      "skip_to_attendance": "Skip and go to roll call",
      "skip_hint": "You can add catechumens later from the class or roll call.",
...
export const parishes_en = {
    ...
    "coverage_quota": "{{name}} already uses {{used}} of {{max}} parishes in the deal. Ask Catequese Viva to expand the agreement.",
    "coverage_paused": "The pastoral deal for {{name}} is not active. Existing data stays; another parish cannot be opened now.",
    ...
    "select_parish_to_manage": "Parish to manage communities",
    "no_institutional_parish": "No parish registered",
    "no_institutional_parish_desc": "Create a parish to add communities and link classes.",
...
export const pastoralReport_en = {
    ...
    "enrollment_status": {
      ...
      "TRANSFERRED": "Transferred",
      "COMPLETED": "Completed",
      "MOVED_TO_OTHER_CLASS": "Moved to another class"
    }
  } as const;
...
export const public_en = {
    ...
    "workspace": {
      ...
      "pending_invites": "Pending Invitations",
      "pending_invites_subtitle": "Accept an invite to join the workspace.",
      ...
      "diocese_deal_paused": "The pastoral deal is suspended or inactive. Data stays; new parishes cannot be opened now.",
      "diocese_parish_quota": "Parishes in the deal: {{used}}/{{max}}. To add another, talk to Catequese Viva.",
...
export const topbar_en = {
    ...
    "plan": {
      ...
      "parish_trial": "Trial period · subscribe to the Parish Plan",
