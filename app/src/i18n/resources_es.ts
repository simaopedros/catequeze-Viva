...
export const billing_es = {
    ...
    "trial_hero_subtitle_institutional_one": "Último día de la prueba de este espacio. Suscríbete al Plan Parroquia para mantener grupos y equipo sin interrupción.",
    "trial_hero_subtitle_institutional_other": "Este espacio está en prueba ({{count}} días restantes). El Plan Catequista sigue en tu espacio personal; aquí el plan a suscribir es el Plan Parroquia.",
