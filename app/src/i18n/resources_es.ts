...
export const admin_es = {
    "sidebar": {
      ...
      "users": "Usuarios",
      "dioceses": "Diócesis",
      "dioceseDeals": "Acuerdos diócesis",
    ...
    "pages": {
      ...
      "plans": {
        ...
        "field_active": "Vendible (necesario para la venta)",
        "field_public": "Público en /pricing y landing",
        ...
        "move_up": "Subir",
        "move_down": "Bajar",
        "field_visibility_help": "Para aparecer en /pricing, landing y billing, el plan debe estar Vendible y Público. Archivar desactiva ambos."
      },
      "system": {
        "title": "Sistema",
        ...
        "jobs": {
          "dailyStats": "Métricas diarias de usuarios, actividad e ingresos",
      ...
      "licenses": {
        ...
        "search_placeholder": "Buscar por entidad, correo o plan",
      ...
      "deals": {
        "title": "Acuerdos diocesanos",
        "subtitle": "Suscripciones combinadas con cada curia: parroquias, vigencia y estado. El pago es offline (PIX, factura o transferencia) — sin checkout de Stripe.",
        "new": "Nuevo acuerdo",
        "new_title": "Nuevo acuerdo pastoral",
        "edit_title": "Editar acuerdo pastoral",
        "form_desc": "Defina cuántas parroquias cubre el acuerdo y los términos internos. La curia solo ve el resumen, no el precio combinado.",
        "search_placeholder": "Buscar diócesis o referencia",
        "filter_status": "Filtrar por estado",
        "filter_all": "Todos los estados",
        "empty": "Ningún acuerdo diocesano",
        "empty_desc": "Cuando una diócesis cierre el acuerdo, registre aquí cuántas parroquias puede usar.",
        "col_diocese": "Diócesis",
        "col_status": "Estado",
        "col_parishes": "Parroquias",
        "col_actions": "Acciones",
        "edit": "Editar",
        "activate": "Activar",
        "suspend": "Suspender",
        ...
        "status_NONE": "Sin acuerdo",
        "unlimited": "Ilimitado",
        "existing_diocese": "Diócesis ya registrada",
        "choose_diocese": "Elegir diócesis…",
        "new_diocese": "O registrar una diócesis nueva",
        "new_diocese_placeholder": "Nombre de la diócesis",
        "max_parishes": "Máximo de parroquias",
        "max_parishes_required": "Indique cuántas parroquias cubre el acuerdo.",
        "max_classes": "Máximo de grupos (opcional)",
        "max_catechists": "Máximo de catequistas (opcional)",
        "max_catechumens": "Máximo de catequizandos (opcional)",
        "status": "Estado",
        "starts": "Inicio",
        "ends": "Término",
        "contract_ref": "Referencia del contrato",
        "agreed_price": "Valor combinado (interno)",
        "notes": "Notas internas",
        "notes_placeholder": "Precio combinado, PIX, número de contrato, contacto de la curia…",
        "cancel": "Cancelar",
        "save": "Guardar acuerdo",
        "saving": "Guardando…",
        "action_error": "No fue posible guardar el acuerdo.",
        "confirm_status_title": "Cambiar el estado del acuerdo",
        "confirm_status_desc": "El acuerdo de {{name}} pasará a {{status}}. Los datos de las parroquias permanecen.",
        "confirm": "Confirmar"
      }
    },
    "loading": "Cargando…",
...
export const attendance_es = {
    ...
    "matrix": {
      ...
      "absent_letter": "F",
      "justified_letter": "J",
      "meetings_count_one": "{{count}} encuentro",
      "meetings_count_plural": "{{count}} encuentros",
      "percent_column": "%",
    ...
    "sheet": {
      ...
      "empty_desc": "Crea el encuentro de hoy para empezar la llamada.",
      "create_today_meeting": "Crear encuentro de hoy",
      "create_meeting_ok": "Encuentro creado. Marca la asistencia abajo.",
      "create_meeting_error": "No se pudo crear el encuentro",
      "default_meeting_title": "Encuentro de hoy",
...
export const billing_es = {
    ...
    "plan_mismatch_personal": "El Plan Catequista se contrata en el espacio personal. En este espacio pastoral, el plan a suscribir es el Plan Parroquia.",
    "plan_mismatch_personal_cta": "Abrir espacio personal",
    ...
    "trial_status_desc_institutional_one": "Queda 1 día de la prueba de este espacio. Suscríbete al Plan Parroquia para grupos y catecúmenos ilimitados.",
    "trial_status_desc_institutional_other": "Quedan {{count}} días de la prueba de este espacio. Suscríbete al Plan Parroquia para grupos y catecúmenos ilimitados.",
    ...
    "trial_hero_subtitle_institutional_one": "Último día de la prueba de este espacio. Suscríbete al Plan Parroquia para grupos y catecúmenos ilimitados.",
    "trial_hero_subtitle_institutional_other": "Este espacio está en prueba ({{count}} días restantes). Suscríbete al Plan Parroquia para grupos y catecúmenos ilimitados.",
    "institutional_trial_plan_label": "Prueba parroquial",
    "trial_usage_caption": "Estos son los límites del periodo de prueba. El Plan Parroquia deja grupos y catecúmenos ilimitados.",
    ...
    "trial_started_title": "Tu prueba de 7 días ha comenzado",
    "trial_started_description": "La tarjeta ya está registrada. El cobro empieza después de los 7 días de prueba. Vamos a preparar tu espacio.",
    "trial_started_redirect": "Te llevaremos a la suscripción en {{seconds}} segundos...",
    "trial_started_redirect_onboarding": "Continuaremos la configuración en {{seconds}} segundos...",
    "go_to_billing": "Ir a la suscripción",
    "go_to_onboarding": "Continuar configuración",
    ...
    "pricing_section_subtitle_personal": "En este espacio personal, el plan a suscribir es el Plan Catequista.",
    "pricing_section_subtitle_institutional": "En este espacio pastoral, el plan a suscribir es el Plan Parroquia.",
    "unlimited": "ilimitado",
    ...
    "parish_offer": {
      ...
      "headline_no_trial": "Lleva la catequesis de tu parroquia al siguiente nivel",
      "result_trial": "Sigue usando Catequese Viva sin límites.",
      "result_no_trial": "Ten a todo tu equipo, grupos y catecúmenos en un solo lugar.",
      "usage_aria": "Comparación del uso actual con el Plan Parroquia",
      "usage_trial_label": "Tu prueba",
      "usage_plan_label": "Plan Parroquia",
      "usage_benefits_label": "Qué incluye la prueba",
      "usage_benefits_aria": "Beneficios del Plan Parroquia en la prueba",
      ...
      "most_popular": "Más popular",
      "plan_result": "Toda la catequesis parroquial en un solo lugar",
      "plan_audience": "Para todo el equipo de tu parroquia",
      "per_month": "/mes",
      "billed_annually": "cobrado anualmente: {{price}}",
      "save_year": "ahorra {{price}}",
      "cta": "Suscribirse al Plan Parroquia",
      "secure_payment": "Pago seguro a través de Stripe",
      "diocese_title": "Tu parroquia puede estar cubierta por la Diócesis",
      "diocese_desc": "Si tu diócesis tiene una licencia activa, tu parroquia podrá vincularse al Plan Diócesis.",
      "diocese_cta": "Hablar con ventas sobre cobertura diocesana",
      "diocese_question": "¿Necesitas cobertura para varias parroquias?",
      "support_question": "¿Dudas sobre la suscripción?",
      "support_cta": "WhatsApp"
    },
    "personal_active": {
      "workspace_eyebrow": "Mi espacio personal",
      "active_badge": "Activo",
      "trial_badge": "En prueba",
      ...
      "headline_trial_other": "Tu prueba termina en {{count}} días",
      "headline_trial_ended": "Tu período de prueba terminó",
      "headline_trial_active": "Tu suscripción está en período de prueba",
      "result": "Todo listo para que continúes tu catequesis.",
      "result_trial": "Ya iniciaste el Plan Catequista. Gestiona la tarjeta y la suscripción, o organiza como parroquia si necesitas más espacio.",
      "manage": "Gestionar suscripción",
      "cancel_link": "Cancelar suscripción",
      "scope_hint": "La suscripción Catequista es personal. Un espacio de parroquia tiene su propia licencia.",
      "your_plan": "Tu plan",
      ...
      "usage_bridge": "¿Necesitas más espacio?",
      "usage_bridge_desc": "Organiza tu parroquia con grupos y catecúmenos ilimitados.",
      "next_step": "Siguiente paso",
      "parish_title": "Lleva tu catequesis a toda la parroquia",
      "parish_desc": "Invita a tu equipo, crea grupos ilimitados y acompaña a todos los catecúmenos en un solo espacio.",
      "parish_cta": "Organizar como parroquia",
      "parish_feature_classes": "Grupos y equipo ilimitados",
      "parish_feature_catechumens": "Catecúmenos ilimitados",
      "parish_feature_team": "Espacio institucional de la parroquia",
      "parish_feature_comms": "Comunicación con las familias",
    ...
    "catechist_offer": {
      ...
      "usage_benefits_label": "Qué incluye la prueba",
      "usage_benefits_aria": "Beneficios del Plan Catequista en la prueba",
      "usage_class_one": "{{count}} grupo",
      "usage_class_other": "{{count}} grupos",
      "usage_catechumen_one": "{{count}} catecúmeno",
      "usage_catechumen_other": "{{count}} catecúmenos",
    ...
    "institutional_active": {
      ...
      "headline_trial_one": "La prueba parroquial termina en 1 día",
      "headline_trial_other": "La prueba parroquial termina en {{count}} días",
      "headline_trial_ended": "El período de prueba de la parroquia terminó",
      "headline_trial_active": "La licencia parroquial está en período de prueba",
      "result": "Todo el equipo usa este espacio con la licencia de la parroquia.",
      "result_trial": "Ya iniciaste el Plan Parroquia. Gestiona la tarjeta y la suscripción aquí.",
      "manage": "Gestionar suscripción",
      "cancel_link": "Cancelar suscripción",
    ...
    "managed_notice": {
      ...
      "paused_headline": "El acuerdo pastoral de esta diócesis no está activo",
      "paused_headline_named": "El acuerdo pastoral de la diócesis {{name}} no está activo",
      "paused_result": "Los datos de las parroquias siguen guardados. No hay checkout aquí: la curia regulariza el acuerdo con Catequese Viva."
    },
    "deal": {
      "eyebrow": "Acuerdo pastoral",
      "covering_desc": "Las parroquias de esta diócesis usan la cobertura combinada con Catequese Viva.",
      "paused_desc": "Mientras el acuerdo no esté activo, no abrimos parroquias nuevas en esta diócesis. Los datos actuales permanecen.",
      "parishes": "Parroquias en el acuerdo",
      "parishes_used": "{{used}} de {{max}}",
      "parishes_unlimited": "ilimitadas",
      "classes": "Grupos (tope)",
      "catechists": "Catequistas (tope)",
      "catechumens": "Catequizandos (tope)",
      "starts": "Inicio: {{date}}",
      "ends": "Término: {{date}}",
      "status_ACTIVE": "Activo",
      "status_SUSPENDED": "Suspendido",
      "status_INACTIVE": "Inactivo",
      "status_NONE": "Sin acuerdo",
      "status_CANCELED": "Inactivo",
      "status_TRIAL": "En prueba",
...
export const classes_es = {
    ...
    "community": "Comunidad",
    "parish": "Parroquia",
    "community_placeholder": "Parroquia (sin comunidad específica)",
    "community_optional": "Opcional — vincule a una comunidad o capilla.",
    "create_parish_first": "Registre una parroquia para crear grupos institucionales.",
    "create_parish_cta": "Crear parroquia",
    "days": {
      "0": "Domingo",
      "1": "Lunes",
      "2": "Martes",
    ...
    "detail": {
      ...
      "empty_cta_attendance": "Hacer llamada",
      ...
      "role_class_coordinator": "Coordinador(a)",
...
export const common_es = {
    ...
    "roles": {
      ...
      "COMMUNITY_COORDINATOR": "Coordinador(a) de comunidad",
      "LEAD_CATECHIST": "Catequista responsable",
    ...
    "team": {
      "scope": {
        "title": "Ámbito de coordinación",
        "description": "Defina qué grupos acompaña {{name}}. Sin comunidad y sin grupos, la persona ve toda la parroquia.",
        "community_label": "Comunidad",
        "no_community": "Sin comunidad (solo grupos elegidos)",
        "classes_label": "Grupos bajo responsabilidad",
        "no_classes": "Aún no hay grupos registrados.",
        "full_parish_hint": "Sin ámbito definido: visión de toda la parroquia (como hoy).",
        "scoped_hint": "La persona verá solo los grupos, catequistas y catequizandos de este ámbito.",
        "saved": "Ámbito actualizado.",
        "edit": "Definir ámbito",
        "classes_count_one": "{{count}} grupo",
        "classes_count_other": "{{count}} grupos",
        "full_parish": "Toda la parroquia",
...
export const dashboard_es = {
    ...
    "rhema": {
      "title": "Rhema",
      "subtitle": "La Comunidad en el mismo día a día del grupo: testimonios, shorts y a quienes sigues.",
      "cta": "Abrir Comunidad",
    ...
    "activation": {
      ...
      "step_attendance_title": "Hacer la primera llamada",
      "step_attendance_desc": "Marca quién vino — toma menos de un minuto.",
...
export const hierarchy_es = {
    ...
    "library": {
      ...
      "title_field": "Título",
      "body": "Texto",
      "policy": "Política de herencia",
      "status_field": "Estado",
      "updated": "Recurso actualizado.",
      "update_error": "No se pudo guardar el recurso.",
      "deleted": "Recurso eliminado.",
      "delete_error": "No se pudo eliminar el recurso.",
      "delete_title": "Eliminar borrador",
      "delete_confirm": "Este borrador se eliminará de forma permanente.",
      "archive": "Archivar",
      "archived": "Recurso archivado.",
      "archive_title": "Archivar recurso",
      "archive_confirm": "Las parroquias dejarán de ver este recurso publicado, pero el historial permanece.",
      "attachments": "Adjuntos",
      "attach": "Adjuntar archivo",
      "attaching": "Enviando…",
      "attached": "Archivo adjunto.",
      "attach_error": "No se pudo adjuntar el archivo.",
      "attachment_removed": "Adjunto eliminado.",
      "remove_attachment": "Quitar adjunto",
      "no_attachments": "Ningún archivo adjunto.",
      "download_error": "No se pudo descargar el adjunto.",
    ...
    "itinerary": {
      ...
      "updated": "Itinerario actualizado.",
      "update_error": "No se pudo guardar el itinerario.",
      "deleted": "Itinerario eliminado.",
      "delete_error": "No se pudo eliminar el itinerario.",
      "delete_title": "Eliminar itinerario",
      "delete_confirm": "Este borrador se eliminará de forma permanente.",
      "archive": "Archivar",
      "archived": "Itinerario archivado.",
      "archive_confirm": "Los años ya instanciados permanecen; el itinerario deja de ofrecerse a las parroquias.",
      "policy": "Política de herencia",
      "status": "Estado",
      "stages": "Etapas",
      "add_stage": "Añadir etapa",
      "stage_name": "Nombre de la etapa",
      "stage_desc": "Descripción de la etapa",
      "empty_desc": "La diócesis publica itinerarios oficiales; la parroquia instancia el año catequético a partir de ellos.",
      "publish": "Publicar",
    ...
    "formation": {
      ...
      "subtitle": "Cree formaciones con módulos y clases. La diócesis publica el programa; la parroquia inscribe al equipo y sigue el progreso.",
      "new": "Nueva formación",
      "name": "Nombre",
      "name_placeholder": "Formación inicial de catequistas",
      "hours": "Carga horaria",
      "hours_placeholder": "Horas totales (opcional)",
      "desc_placeholder": "Objetivo, público y lo que el equipo va a aprender…",
      "saving": "Guardando…",
      "created": "Formación creada. Ahora arme el programa.",
      "create_error": "No se pudo crear la formación.",
      "enroll": "Inscribirme",
      "unenroll": "Cancelar inscripción",
      "open": "Abrir formación",
      "policy": "Política de herencia",
      "updated": "Formación actualizada.",
      "update_error": "No se pudo guardar la formación.",
      "deleted": "Formación eliminada.",
      "delete_error": "No se pudo eliminar.",
      "delete_title": "Eliminar formación",
      "delete_confirm": "Las formaciones con inscritos o contenido se archivan; los borradores vacíos se eliminan.",
      "archived": "Formación archivada.",
      "not_found": "Formación no encontrada",
      "detail_subtitle": "{{modules}} módulos · {{lessons}} clases · {{sessions}} encuentros · {{enrolled}} inscritos",
      "inherited_readonly": "Programa oficial: la parroquia inscribe al equipo y marca el progreso, pero solo la curia edita módulos y clases.",
      "tab_program": "Programa",
      "tab_sessions": "Encuentros en vivo",
      "tab_roster": "Inscritos",
      "curriculum_title": "Programa del curso",
      "curriculum_hint": "Organice la formación en módulos. Cada módulo reúne las clases con contenido, duración y material.",
      "add_module": "Añadir módulo",
      "module_title": "Título del módulo",
      "module_title_placeholder": "Módulo 1 — Identidad del catequista",
      "module_desc_placeholder": "Qué cubre este módulo…",
      "save_module": "Guardar módulo",
      "module_created": "Módulo creado.",
      "module_updated": "Módulo actualizado.",
      "module_error": "No se pudo guardar el módulo.",
      "module_deleted": "Módulo eliminado.",
      "delete_module_title": "Eliminar módulo",
      "delete_module_confirm": "Las clases de este módulo también se eliminarán.",
      "empty_curriculum": "Aún no hay módulos. Cree el primero para empezar a montar las clases.",
      "empty_curriculum_readonly": "Esta formación todavía no tiene un programa publicado.",
      "lessons_count": "{{count}} clases",
      "add_lesson": "Añadir clase",
      "lesson_title": "Título de la clase",
      "lesson_title_placeholder": "Clase 1 — Llamado y vocación",
      "lesson_body": "Contenido",
      "lesson_body_placeholder": "Texto de la clase, pauta, referencias bíblicas, preguntas para el grupo…",
      "lesson_duration": "Duración (minutos)",
      "lesson_video": "Vídeo (URL)",
      "lesson_resource": "Material de apoyo (URL)",
      "save_lesson": "Guardar clase",
      "lesson_created": "Clase creada.",
      "lesson_updated": "Clase actualizada.",
      "lesson_error": "No se pudo guardar la clase.",
      "lesson_deleted": "Clase eliminada.",
      "delete_lesson_title": "Eliminar clase",
      "delete_lesson_confirm": "El progreso de los inscritos en esta clase se eliminará.",
      "empty_lessons": "Ninguna clase en este módulo.",
      "open_lesson": "Abrir clase",
      "close_lesson": "Cerrar clase",
      "mark_complete": "Marcar como concluida",
      "completed": "Concluida",
      "reopen_lesson": "Reabrir clase",
      "progress": "{{done}} de {{total}} clases concluidas",
      "enroll_to_progress": "Inscríbase para marcar el progreso en las clases.",
      "sessions_title": "Encuentros en vivo",
      "sessions_hint": "Programe encuentros presenciales o en vivo. El programa (módulos y clases) queda arriba.",
      "add_session": "Encuentro",
      "session_title": "Título del encuentro",
      "session_starts": "Inicio",
      "session_ends": "Término",
      "session_location": "Lugar",
      "session_hours": "Horas de este encuentro",
      "location_placeholder": "Salón parroquial, seminario…",
      "notes_placeholder": "Pauta, material, observaciones…",
      "save_session": "Agendar",
      "session_created": "Encuentro agendado.",
      "session_error": "No se pudo agendar el encuentro.",
      "session_deleted": "Encuentro eliminado.",
      "delete_session_title": "Eliminar encuentro",
      "delete_session_confirm": "La lista de asistencia de este encuentro también se eliminará.",
      "empty_sessions": "Ningún encuentro en vivo agendado. El programa del curso puede existir sin fecha en la agenda.",
      "mark_present": "Marcar presencia",
      "present": "Presente",
      "absent": "Ausente",
      "attendance": "Asistencia",
      "enrollments_title": "Inscritos",
      "empty_title": "Ninguna formación",
      "empty_desc": "Cree la primera formación con módulos y clases, o espere a que la diócesis publique la escuela de catequistas.",
      "meta": "{{modules}} módulos · {{lessons}} clases · {{enrolled}} inscritos · {{hours}}h",
      "kinds": {
        "INITIAL": "Inicial",
...
export const landing_es = {
    "hero": {
      ...
      "trust_signals": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras",
    ...
    "features": {
      ...
      "rhema": {
        "title": "Comunidad Rhema, al mismo ritmo de la catequesis",
        "desc": "La red pastoral vive junto al grupo, la agenda y la biblioteca. Después del encuentro, el testimonio sigue en la Comunidad — sin salir de la plataforma.",
        "b1": "Panel, grupos y Comunidad en el mismo día a día",
        "b2": "Comparte encuentros, la Palabra y la biblioteca en un toque",
        "b3": "Las familias también siguen la Comunidad en el portal"
      }
    },
    ...
    "personas": [
      {
        "title": "Catequista",
        "desc": "Organiza tu grupo, prepara encuentros con la biblioteca pastoral y comparte lo que viviste en la Comunidad."
      },
      {
      ...
      },
      {
        ...
        "desc": "Acompaña asistencia, avisos, documentos y la Comunidad desde el portal."
      },
      {
        "title": "Párroco",
    ...
    "steps_title": "De la preparación al encuentro.",
    "steps_subtitle": "",
    "steps": [
      {
        "title": "Prepara",
        "desc": "Arma tu encuentro en pocos minutos."
      },
      {
        "title": "Organiza",
        "desc": "Ten grupos, calendario e información de los catequizandos en un solo lugar."
      },
      {
        "title": "Encuentra",
        "desc": "Llega al encuentro sabiendo exactamente qué hacer."
      },
      {
        "title": "Acompaña",
        "desc": "Registra asistencia y sigue el camino de cada catequizando."
      }
    ],
    ...
    "mockup_rhema": {
      ...
      "caption": "Encuentro de hoy: el Padre Nuestro. ¡Amén!",
      "amen": "Amén"
    },
    "footer": {
    ...
    "trust": [
      ...
      {
        "title": "7 días gratis",
        "desc": "Acceso a todos los recursos. Si no encaja, cancela cuando quieras."
      },
      {
    ...
    "testimonials": [],
    "cta_helper": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras",
    "mobile_cta": {
      "title": "7 días gratis",
      "subtitle": "Acceso a todos los recursos · Cancela cuando quieras",
    ...
    "proof": {
      ...
      "launch_text": "Crea la cuenta y prueba 7 días con acceso a todos los recursos. Cancela cuando quieras.",
      "promises": [
        "7 días gratis, con acceso a todos los recursos",
        "Biblioteca con Biblia y Catecismo en el mismo lugar",
        "Datos de niños con cuidado y LGPD",
        "Cancela cuando quieras"
      ],
      "launch_cta": "Empezar gratis por 7 días",
      "launch_helper": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras"
    },
    "simple_features": {
    ...
    "price_trial_badge": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras",
    "price_trial_note": "",
    "comparison": {
      ...
      "helper": "7 días gratis, con acceso a todos los recursos. Cancela cuando quieras.",
      "rows": [
        {
    ...
    "faq_cta_helper": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras",
    ...
    "demo": {
      ...
      "prompt_label": "Tema",
      "generate": "Preparar mi encuentro",
      "regenerate": "Preparar de nuevo",
      "generating": "Preparando el encuentro…",
      "empty": "Toca “Preparar mi encuentro” para ver un guion de ejemplo.",
    ...
    "problem": {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "Asistencias, historial e información de los catequizandos difíciles de seguir."
        },
        {
    ...
    "transform": {
      "eyebrow": "",
      "title": "Menos organización. Más encuentro.",
      "col_before": "Antes",
      "col_after": "Con Catequese Viva",
      "rows": [
        {
          "before": "Cuaderno",
          "after": "Encuentros organizados"
        },
        {
          "before": "WhatsApp",
          "after": "Comunicación centralizada"
        },
        {
          "before": "Planillas",
          "after": "Asistencias registradas"
        },
        {
          "before": "Archivos",
          "after": "Historial de los catequizandos"
        },
        {
          "before": "Improvisación",
          "after": "Encuentro preparado"
        }
      ]
    },
    "presence": {
      "title_line1": "Más corazón en el encuentro.",
      "title_line2": "Menos peso en la semana.",
      "subtitle": "Catequese Viva cuida la parte que nadie ve para que tú puedas cuidar la parte que realmente importa."
    },
    "start_small": {
      "eyebrow": "Empieza pequeño.",
      "title": "Ve la diferencia en el próximo encuentro.",
      "subtitle": "No necesitas organizar todo de una vez.",
      "today_title": "Hoy",
      "next_title": "En el próximo encuentro",
      "today": [
        "Crea tu grupo",
        "Registra a tus catequizandos",
        "Prepara el próximo encuentro"
      ],
      "next": [
        "Ten todo organizado",
        "Registra las asistencias",
        "Continúa donde lo dejaste"
      ],
      "cta": "Empezar mi catequesis — 7 días gratis"
    },
    "growth": {
      ...
      "note": "7 días gratis · Acceso a todos los recursos · Cancela cuando quieras",
      ...
      "stories": [
        {
          "title": "Empieza solo.",
          "desc": "Organiza tu catequesis personal."
        },
        {
          "title": "¿Creció?",
          "desc": "Invita a tu equipo y organiza tu parroquia."
        },
        {
          "title": "¿Tu diócesis quiere participar?",
          "desc": "Conecta varias parroquias en una sola estructura."
        }
      ],
      "compare": "Comparar detalles de los planes"
    }
  } as const;
...
export const onboarding_es = {
    ...
    "diocese": {
      ...
      "not_found_link": "+ ¿No la encontró? Consultar el plan Diócesis",
      "not_found_title": "Crear diócesis es un plan institucional",
      "not_found_body": "Solo el equipo de la plataforma registra diócesis nuevas. Puedes seguir sin diócesis y organizar la parroquia con normalidad — o hablar con ventas sobre el plan Diócesis.",
      "continue_without": "Continuar sin diócesis",
      "whatsapp_question": "¿Quieres el plan Diócesis para tu región?",
      "whatsapp_helper": "El equipo de ventas explica cobertura, precios y cómo activar el plan Diócesis.",
      "whatsapp_cta": "Consultar plan Diócesis en WhatsApp",
      "whatsapp_prefill": "¡Hola! Estoy en el registro de Catequese Viva y quiero saber más sobre el plan Diócesis.",
    ...
    "shell": {
      ...
      "personal_people_subtitle": "Añade nombres ahora o salta — la llamada ya está lista.",
    ...
    "catechumens_setup": {
      ...
      "continue_attendance": "Hacer llamada con {{count}} en el grupo",
      "continue_attendance_empty": "Ir a la llamada",
      "skip_to_attendance": "Saltar e ir directo a la llamada",
      "skip_hint": "Puedes incluir catequizandos después, en el grupo o en la llamada.",
...
export const parishes_es = {
    ...
    "coverage_quota": "{{name}} ya usa {{used}} de {{max}} parroquias del acuerdo. Amplíe el combinado con Catequese Viva.",
    "coverage_paused": "El acuerdo pastoral de {{name}} no está activo. Los datos actuales permanecen; no es posible abrir otra parroquia ahora.",
    ...
    "select_parish_to_manage": "Parroquia para gestionar comunidades",
    "no_institutional_parish": "Ninguna parroquia registrada",
    "no_institutional_parish_desc": "Cree una parroquia para registrar comunidades y vincular grupos.",
    ...
    "class_coordinator": "Coordinador(a)",
...
export const public_es = {
    ...
    "sales_whatsapp": {
      "question": "¿Dudas sobre la suscripción o los planes?",
      "cta": "Habla con ventas por WhatsApp",
      "cta_short": "WhatsApp de ventas",
      "helper": "El equipo de ventas resuelve tus dudas sobre el plan y la suscripción.",
      "prefill": "¡Hola! Quiero saber más sobre los planes de Catequese Viva.",
    ...
    "workspace": {
      ...
      "diocese_deal_paused": "El acuerdo pastoral está suspendido o inactivo. Los datos permanecen; no abrimos parroquias nuevas ahora.",
      "diocese_parish_quota": "Parroquias del acuerdo: {{used}}/{{max}}. Para incluir otra, hable con Catequese Viva.",
...
export const settings_es = {
    ...
    "rhema": {
      "title": "Rhema",
      "hint": "Tu perfil público en la Comunidad. El handle aparece como @nombre.",
      "handle": "Handle",
      "handle_placeholder": "tu_handle",
      "bio": "Bio",
      "bio_placeholder": "Una frase sobre tu catequesis",
      "open_profile": "Ver perfil en la Comunidad",
      "open_community": "Abrir Comunidad"
    },
...
export const social_es = {
    "title": "Comunidad",
    "eyebrow": "Comunidad",
    "subtitle": "El espacio donde la catequesis continúa después del grupo, la agenda y la biblioteca.",
    "publicSubtitle": "El espacio donde la catequesis continúa después del grupo, la agenda y la biblioteca.",
    "hero": {
      "eyebrow": "COMUNIDAD",
      "title": "Juntos en la misión de evangelizar",
      "description": "El espacio donde la catequesis continúa después del grupo, la agenda y la biblioteca."
    },
    "rail": {
      "members": "Miembros de la comunidad",
      "membersCount": "{{count}} miembro",
      "membersCount_plural": "{{count}} miembros",
      "membersEmpty": "Todavía no hay autores publicados.",
      "seeMembers": "Ver la comunidad",
      "promoTitle": "Conoce Catechis",
      "promoBody": "Herramientas para el día a día del catequista. Prepara encuentros increíbles en minutos con ayuda de la IA.",
      "promoCta": "Saber más →",
    ...
    "composer": {
      ...
      "videoTooLarge": "El vídeo puede tener como máximo 60 MB.",
    ...
    "share": {
      ...
      "bibleBody": "Palabra: {{reference}}",
      "bibleVerseBody": "{{reference}} — «{{text}}»",
      "catechismBody": "CIC {{number}} — {{question}}\n\n{{answer}}",
      "directoryBody": "Compendio §{{number}}{{titleSuffix}}\n\n{{content}}"
    },
    "post": {
    ...
    "discovery": {
      ...
      "foryou": "Para ti",
      "shorts": "Shorts",
      "emptyForyou": "Aún estamos aprendiendo tu gusto",
      "emptyForyouDescription": "Reacciona y mira shorts para recibir recomendaciones.",
      "block": "Bloquear",
      "unblock": "Desbloquear",
    ...
    "companion": {
      ...
      "classes": {
        ...
        "body": "El grupo es el encuentro presencial. La Comunidad es donde lo vivido sigue dando fruto."
      },
      "catechism": {
        "title": "Catecismo y Comunidad",
        "body": "Estudia el Catecismo aquí. Si una respuesta ilumina tu grupo, compártela en la Comunidad."
      },
      "sacraments": {
        "title": "Sacramentos y Comunidad",
        "body": "El itinerario sacramental es acompañamiento pastoral. La Comunidad es el testimonio público de esa fe."
      },
      "directory": {
        "title": "Compendio y Comunidad",
        "body": "El Compendio profundiza la doctrina. La Comunidad es donde se vuelve conversación."
      }
    },
    "invitePrompt": {
      "title": "Invita a alguien a la Comunidad",
      "description": "La fe crece en compañía. Envía tu enlace a un amigo o familiar.",
      "copyLink": "Copiar enlace",
      "whatsapp": "WhatsApp",
      "share": "Compartir",
      "dismiss": "Ahora no",
      "copied": "Enlace copiado",
      "message": "Ven a participar en la Comunidad conmigo:"
    },
    "nativeShare": {
...
export const topbar_es = {
    ...
    "plan": {
      ...
      "parish_trial": "Periodo de prueba · suscríbete al Plan Parroquia",
