...
export const common_es = {
    ...
    "portal_invites": {
      ...
      "offline_grant_failed": "No se pudo registrar la autorización offline. Compruebe permisos de coordinación.",
      "invite_without_grant_hint": "La invitación se enviará igualmente, pero el menor seguirá necesitando autorización para activar la cuenta."
    }
  } as const;
