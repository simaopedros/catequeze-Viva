...
export const billing_pt_BR = {
    ...
    "trial_hero_subtitle_institutional_one": "Último dia do teste deste espaço. Assine o Plano Paróquia para manter turmas e equipe sem interrupção.",
    "trial_hero_subtitle_institutional_other": "Este espaço está em teste ({{count}} dias restantes). O Plano Catequista continua no seu espaço pessoal; aqui o plano a assinar é o Plano Paróquia.",
