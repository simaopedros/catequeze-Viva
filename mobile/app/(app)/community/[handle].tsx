...
export default function ProfileRoute() {
  ...
  const posts = usePagedList(
    (cursor) =>
      profileId
        ? api.socialFeed({ authorId: profileId, sort: 'recent', cursor })
  ...
  return (
    <ProfileScreen
      ...
      postsHasMore={Boolean(posts.nextCursor)}
      postsLoadingMore={posts.loadingMore}
      onLoadMorePosts={() => void posts.loadMore()}
