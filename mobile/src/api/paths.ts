export const MOBILE_PATHS = {
  ...
  attendanceSheet: (id: string) => `/mobile/meetings/${encodeURIComponent(id)}/attendance`,
  ...
  journey: (id: string) => `/mobile/journeys/${encodeURIComponent(id)}`,
  ...
  socialImages: '/api/social/images',
  socialVideoFile: '/api/social/videos',
